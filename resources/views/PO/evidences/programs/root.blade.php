    ...
    <div class="container">
        ...
        <div class="row g-3">
            @foreach ($folder as $item)
                <div class="col-2">
                    <a class="folder btn d-flex align-items-center justify-content-center" href="{{ route('po-program-parent-process',[request()->route('program'),request()->route('process'),$item->id]) }}">
                        {{ $item['folder_name'] }}
                    </a>
                </div>
            @endforeach
